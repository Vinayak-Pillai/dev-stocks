...
ALTER TABLE "product_variant_prices" ADD CONSTRAINT "product_variant_prices_product_variant_type_id_tax_types_tax_id_fk" FOREIGN KEY ("product_variant_type_id") REFERENCES "public"."tax_types"("tax_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
